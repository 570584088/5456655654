...
public class TtRequest2 extends Request<ArrayList<TtBean>>{
    private Response.Listener<ArrayList<TtBean>> listener;

    public TtRequest2(String url, Response.Listener <ArrayList<TtBean>> listener,Response.ErrorListener errorListener) {
        this(Method.GET,url,listener,errorListener);
    }


    public TtRequest2(int method, String url, Response.Listener<ArrayList<TtBean>> listener, Response.ErrorListener errorListener) {
    ...
    public TtRequest2(int method, String url, Map<String, String> map, Response.Listener<ArrayList<TtBean>> listener, Response.ErrorListener errorListener) {
        super(method, url, errorListener);
        this.listener = listener;
        this.map = map;
    }
    ...
    protected Response<ArrayList<TtBean>> parseNetworkResponse(NetworkResponse response) {
        ...
        try {
            ...
            for (int i = 0; i < ja.length(); i++) {
                ...
                tb.setIstop(obj.getString("commentcount"));
