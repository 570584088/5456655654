...
public class news_meiRong extends Fragment{
            ...
            public void onLoadMore() {
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        for (int i = 2; i < 11; i++) {
                            TtRequest2 tr = new TtRequest2("http://api.club.xywy.com/mobile_app_article.php?act=article_list&categoryid=34&page="+i+"&pagesize=10&sign=32db8de759de66d86d9ee1c645e517e1",
    ...
    private void initData() {
        ...
        TtRequest2 tr = new TtRequest2("http://api.club.xywy.com/mobile_app_article.php?act=article_list&categoryid=34&page=1&pagesize=10&sign=32db8de759de66d86d9ee1c645e517e1",
                new Response.Listener<ArrayList<TtBean>>() {
                    @Override
                    public void onResponse(ArrayList<TtBean> response) {
...
//            String istop = list.get(position).getIstop();
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 1:
                    holder = new news_meiRong.MyAdapter.item2(LayoutInflater.from(getActivity()).inflate(R.layout.activity_news_item2,parent,false));
                    break;
                case 2:
                    holder = new news_meiRong.MyAdapter.item(LayoutInflater.from(getActivity()).inflate(R.layout.activity_news_item,parent,false));
                    break;
            }
            return holder;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            switch (getItemViewType(position)) {
                case 1:
                    final news_meiRong.MyAdapter.item2 i2 = (news_meiRong.MyAdapter.item2) holder;
//                    loader.displayImage(tb.getImgurl(),i2.rv_iv2);
                    ...
                    break;
                case 2:
                    final news_meiRong.MyAdapter.item i1 = (news_meiRong.MyAdapter.item) holder;
